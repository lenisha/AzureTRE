...
locals {
  ...
  allowed_service_tags           = ["AzureActiveDirectory", "AzureResourceManager", "AzureMachineLearning", "BatchNodeManagement", "${data.azurerm_network_service_tags.storage.id}", "MicrosoftContainerRegistry"]
